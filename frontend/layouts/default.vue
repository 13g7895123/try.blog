          ...
          <button @click="toggleDarkMode"
            ...
            <svg v-else class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd"
                d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.536l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.828-2.828l.707.707a1 1 0 11-1.414 1.414l-.707-.707a1 1 0 111.414-1.414zM13 11a1 1 0 110 2h-1a1 1 0 110-2h1zm4-4a1 1 0 110 2v1a1 1 0 11-2 0v-1a1 1 0 012-1z"
                clip-rule="evenodd" />
            </svg>
          </button>
    ...
    <div class="flex-1 overflow-auto">
      ...
      <div v-if="showMobileSidebar"
        ...
        <div class="px-4 py-4 space-y-3 max-h-64 overflow-y-auto">
          <NuxtLink to="/" @click="showMobileSidebar = false"
          ...
          <div v-for="item in mobileTags" :key="item.tag.id"
